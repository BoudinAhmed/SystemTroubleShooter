...
namespace SystemTroubleShooter.ViewModel
{
    ...
    public class HomeViewModel : ViewModelBase
    {
        ...
        private void LoadIssueItems()
        {
            ...
            IssueItems.Add(new IssueItemViewModel { Title = "Windows Update", Description = "Resolve problem with windows update", ImageSource = "\xE895", IssueType = new WindowsUpdateTroubleshooter() });
